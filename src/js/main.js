...
document.addEventListener('DOMContentLoaded', function () {
  ...
  tl.from('.title__pagetitle', 2.5, {opacity: 0, ease: Power2.easeOut})
  ...
  tl.from('#pagination', 0.7, {opacity: 0, left: '-=20px', ease: Power2.easeOut})
  tl.from('.scroll__indication', 0.7, {opacity: 0, bottom: '20px', ease: Power2.easeOut})
